...
// Model: 
// Model Creator: 
// Created on: 20.07.2026 - 08:17:46
// Last changed on: 20.07.2026 - 08:17:46
package com.jcirmodelsquad.tcjcir.models.loads; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class Modelhazmat_plac_11000 extends ModelConverter //Same as Filename
{
	int textureX = 32;
	int textureY = 32;

	public Modelhazmat_plac_11000() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(-14F, -0.1F, 11.04F);
		...
		bodyModel[1].setRotationPoint(14F, -0.1F, -11.04F);
		...
		bodyModel[2].setRotationPoint(-23.04F, 0F, 0F);
		...
		bodyModel[3].setRotationPoint(23.04F, 0F, 0F);
