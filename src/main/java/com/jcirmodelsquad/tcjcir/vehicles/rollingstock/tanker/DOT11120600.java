...
import com.jcirmodelsquad.tcjcir.models.loads.Modelhazmat_plac_20600;
...
public class DOT11120600 extends AbstractStandardTankerCar {
    ...
    public DOT11120600(World world) {
        ...
        setCargoManager(new CargoManager(new CargoSpecification[][] {
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_flammable_number",
                ...
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_corrosive_number",
                        "Hazmat Placard - Corrosive (Bulk)", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_hot",
                        "Hazmat Placard - HOT", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_oxidizer",
                        "Hazmat Placard - Oxidizer/Oxygen", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_class9_numbers",
                ...
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_class6",
                        "Hazmat Placard - Class 6 (Poision, PG III, Toxic)", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_wet",
                        "Hazmat Placard - Dangerous when Wet", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_explosives",
                        "Hazmat Placard - Explosives", 0, 3, 0)},
                { new CargoSpecification(Modelhazmat_plac_20600.class, "loads/hazmat_plac_radioactive",
