...
public enum EnumTrains {
	...
	GSC53Foot8_6Bulkhead("GSC_53_86Bulkhead", GSC53Foot86Bulkhead.class, ItemIDs.minecartGSC5386FootBulkhead.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Red", "Purple", "Black", "Lime", "White", "Grey", "Yellow"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
